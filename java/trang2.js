...
window.onload = function() {
    ...
    // Hàm để hiện danh sách bài hát yêu thích và ẩn thư viện
    function showLoveSongs() {
    ...
    heartIcon.onclick = showLoveSongs;
    heartText.onclick = showLoveSongs;

    // Gán sự kiện click cho biểu tượng list và chữ "Thư viện"
    listIcon.onclick = showLibrarySongs;
    listText.onclick = showLibrarySongs;
